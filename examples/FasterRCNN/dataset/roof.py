...
__all__ = ['register_roof']


class RoofDetection(DatasetSplit):
    ...
    def __init__(self, basedir, split):
        ...
        Examples:
            ...
            use `RoofDetection(DIR, 'XX')` and `RoofDetection(DIR, 'YY')`
        """
...
if __name__ == '__main__':
    basedir = '~/data/pylon'
    c = RoofDetection(basedir, 'train-pylon')
